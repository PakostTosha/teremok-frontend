		...
		<div className="task">
			{tryCount > 0 ? (
				<>
					...
					<p className="info">
						Была допущена ошибка. Посмотри на подсказку и попробуй выполнить задание
						снова
					</p>
				</>
			) : (
			...
			<div className="task-wrapper">
				<form className="task-container" onSubmit={handleSubmit(checkingTask)}>
					{/* Блок подсказок */}
					{tryCount > 0 && (
						<>
							<div className="help">
					...
					<div className="task-content">
						{selectedTypeTask === "Сложение" || selectedTypeTask === "Вычитание" ? (
							<>
							...
							<>
								<div className="">"Разметка состав числа/порядковый счёт"</div>
							</>
						)}
					</div>
